<?php
  ...
  function urlrewrite() {
    ...
    write_controller_rules(array("controller" => "admin", "binet_prefix" => true, "except" => array("show", "edit", "update"), "action_on_collection" => array("new_viewer", "create_viewer"), "action_on_member" => array("delete_viewer")));
