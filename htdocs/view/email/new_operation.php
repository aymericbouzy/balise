<p>
  L'opération <?php echo pretty_operation($parameters["operation"]); ?> a été proposée par <?php echo pretty_student($parameters["student"]); ?> pour le binet <?php echo pretty_binet_term($parameters["binet"]."/".$parameters["term"], true, false); ?>.
