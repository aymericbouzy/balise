      ...
      <i class="fa fa-plus-circle green-plus" id="operation-plus"></i> <span class="caret"></span>
    	...
    	<ul class="dropdown-menu" role="menu">
      	<li class="add-operation">
     		...
     		<li>
        		<?php echo link_to(path("new", "budget", "", binet_prefix($binet["id"], $term)), "<i class=\"fa fa-fw fa-bar-chart\"></i> Ligne budgétaire", ""); ?>
      		</li>
      	<li class="add-operation">
        		<?php echo link_to(path("new", "request", "", binet_prefix($binet["id"], $term)), "<i class=\"fa fa-fw fa-money\"></i> Demande de subvention", ""); ?>
      		</li>
      	...
      	<?php if (select_binet($binet["id"], array("subsidy_provider"))["subsidy_provider"] == 1) {?>
        	<li class = "divider"></li>
        	<li>
          	<?php echo link_to(path("new", "wave", "", binet_prefix($binet["id"], $term)), "<i class=\"fa fa-fw fa-money\"></i> Vague de subvention", ""); ?>
        		</li>
        	...
        	<li class = "divider"></li>
        	<li class="add-operation">
          	<?php echo link_to(path("new", "binet"), "<i class=\"fa fa-fw fa-group\"></i> Binet", ""); ?>
        	</li>
        	<?php
      		}
      	?>
