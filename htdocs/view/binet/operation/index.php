...
<div class="row">
  ...
  <div class="col-lg-10 col-md-10 col-sm-12">
    <?php
    if (has_editing_rights(binet, term) && sizeOf($pending_validations_operations) > 0) {
      ?>
                  ...
                  foreach ($pending_validations_operations as $operation) {
                    ...
                    <tr>
                      ...
                      <td>
                        <?php
                        echo insert_tooltip(
                          link_to(path("delete", "operation", $operation["id"], binet_prefix(binet, term), array(), true),
...
<div class="row">
    ...
    <div class="row">
      <div id="transfer_budgets">
        <?php echo link_to(path("new", "operation", "", binet_prefix(binet, term)), "<i class=\"fa fa-fw fa-database\"></i> Nouvelle opération", array("class" => "btn")); ?>
      </div>
    </div>
	  <div class="panel shadowed">
