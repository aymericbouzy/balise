<div id="index-wrapper">
  ...
  ?>
    ...
    <?php
  } else { //  if(sizeOf($requests)>0) ... else
    ?>
    <div class="panel shadowed light-blue-background">
      <div class="content">
        Vous n'avez fait aucune demande de subventions ! <br/>
        Si il ya une vague active, vous pouvez en faire sur le bouton <i class="fa fa-fw fa-plus-circle"></i> situé dans la barre supérieure.
      </div>
    </div>
    <?php } ?>
</div>
