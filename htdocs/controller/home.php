<?php
  ...
  case "login":
    if (!isset($_GET["response"])) {
      ...
      if (is_empty($students)) {
        ...
        $_SESSION["notice"][] =
          "Bienvenue sur le site balise ! Tu trouveras ici toutes les informations pour gérer la trésorerie de tes binets,
  ...
  case "bug_report":
    ...
    mail_with_headers(WEBMASTER_EMAIL, get_bug_reference(), $_POST["report"]."\n\n".$_POST["information"], $student["name"]. " <".$student["email"].">");
