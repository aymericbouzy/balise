<?php
  ...
  header_if(!in_array($full_controller, array("binet", "home", "operation", "tag", "wave", "student", "binet/admin", "binet/budget", "binet/operation", "binet/request", "binet/wave", "error")), 404);
